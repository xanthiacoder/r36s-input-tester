...
function K.init()
	bgart[997] = love.graphics.newImage("bgart/starfield.jpg")
end
...
function K.draw()
    ...
    love.graphics.printf(math.floor(frameElapsed/60) .. " seconds, " .. frameElapsed .. " frames (scene 997)", mainFont, 0, 18*23, 640, "right" )
